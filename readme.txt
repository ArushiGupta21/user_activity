...
cd user_activity/
(venv) agupta17-ltm:user_activity agupta17$ python manage.py  runserver

# create app = check_activity_app
(venv) agupta17-ltm:user_activity agupta17$ python manage.py startapp check_activity_app
...
api is - > http://127.0.0.1:8000/user_activity/
result ->
